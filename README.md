...
<table>
  <tr>
    ...
    <td>
      <h2 align="center" style="margin:0;"><em>A  Hammerspoon configuration for quickly</br>launching a set of applications,</br>and binding them to shortcuts for fast switching.</em></h2>
    </td>
  </tr>
</table>
